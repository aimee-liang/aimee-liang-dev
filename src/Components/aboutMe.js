...
const AboutMe = props => {
    return(
        <p>
            Hello! I’m Aimee, and I’m a Fullstack Web Developer and Software Engineer. I love coding, traveling, Game of Thrones (we don’t talk about Season 8 here) and learning everything I can under the sun. 
            ...
            I am both a graduate of The George Washington University and Flatiron School. 
        </p>
    )
}
